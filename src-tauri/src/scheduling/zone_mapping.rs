//! can microsoft please stop being goofy
//! generated by https://github.com/mitsuhiko/localzone/blob/8f8d859333066249b8b9a818c1e4c937d227a851/scripts/make-win-mapping.py
...
pub const ZONE_MAPPINGS: &[ZoneMapping] = &[
    ...
    ZoneMapping {
        windows: "Eastern Standard Time",
        territory: "CA",
        iana: &["America/Toronto", "America/Iqaluit"],
    },
    ZoneMapping {
        windows: "Eastern Standard Time",
        territory: "US",
    ...
    ZoneMapping {
        windows: "South Sudan Standard Time",
        territory: "001",
        iana: &["Africa/Juba"],
    },
    ZoneMapping {
    ...
    ZoneMapping {
        windows: "Volgograd Standard Time",
        territory: "001",
    ...
    ZoneMapping {
        windows: "Qyzylorda Standard Time",
        territory: "001",
        iana: &["Asia/Qyzylorda"],
    },
    ZoneMapping {
    ...
    ZoneMapping {
        windows: "Tasmania Standard Time",
        territory: "AU",
        iana: &["Australia/Hobart", "Antarctica/Macquarie"],
    },
    ZoneMapping {
